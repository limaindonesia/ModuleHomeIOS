//
//  MockConsultationHistoryRepository.swift
//  HomeFlow
//
...
public class MockConsultationHistoryRepository: ConsultationHistoryRepositoryLogic {
  ...
  public func getConsultations(
        ...
        "data": [
          {
            ...
            "service_type": "REGULAR_AUDIO_VIDEO",
            "service_type_name": "Chat + Audio + Video Call"
          }
        ],
        "links": {
    ...
    let jsonModel = try JSONDecoder().decode(
      ConsultationHistoryResponse.self,
