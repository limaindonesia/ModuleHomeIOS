...
public class HistoryPagerTabViewController: SlidingTabController {
  ...
  private let makeLegalFormDocumentViewerViewController: (URL?) -> LegalFormDocumentViewerViewController
  ...
  public init(
    ...
    legalFormDocumentViewerViewControllerFactory: @escaping (URL?) -> LegalFormDocumentViewerViewController
  ) {
    ...
    self.makeLegalFormDocumentViewerViewController = legalFormDocumentViewerViewControllerFactory
  ...
  private func subscribe(to publisher: AnyPublisher<HistoryPagerTabNavigation, Never>) {
    publisher
  ...
  private func respond(_ navigationAction: HistoryPagerTabNavigation) {
  ...
  private func present(_ view: HistoryPagerTabViewState) {
    ...
    case .documentDetail(let url):
      presentDocumentDetail(url)
  ...
  private func presentDocumentDetail(_ url: URL?) {
    let vc = LegalFormDocumentViewerViewController(pdfURL: url)
    navigationController?.pushViewController(vc, animated: true)
  }
